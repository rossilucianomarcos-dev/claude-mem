#!/usr/bin/env bash
# Instala las skills de seguridad del vault en un directorio de skills de
# Claude Code.
#
...
#
# Se copia, no se enlaza, por consistencia con vault/design-skills/install.sh.
set -euo pipefail
...
echo "$count skills de seguridad instaladas en $DEST"
